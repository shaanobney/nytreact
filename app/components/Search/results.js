                        ...
                        <li className="list-group-item">
                            <h3>
                                ...
                                <a href={article.web_url} target="_blank">
                                    <button className="btn btn-default ">READ</button>
                                </a>
                                    <button className="btn btn-primary" onClick={this.handleClick.bind(this, article)}><i className="fa fa-floppy-o" aria-hidden="true"></i></button>
                                </span>
                            </h3>
